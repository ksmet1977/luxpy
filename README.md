 ...
 * If the jupyter notebook fails to download or gives an error (Github seems to experience some type of problem sometimes with its jupyter notebook backend), try opening it up from [nbviewer.jupyter.org/github/ksmet1977/luxpy/blob/master/luxpy_basic_usage.ipynb](https://nbviewer.jupyter.org/github/ksmet1977/luxpy/blob/master/luxpy_basic_usage.ipynb) and then download it from there. 
