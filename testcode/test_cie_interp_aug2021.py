...
def cie_interp_old(data, wl_new, kind = None, sprague5_allowed = False, negative_values_allowed = False,
               extrap_values = 'ext', extrap_kind = 'linear', extrap_log = False):
    """
    Interpolate / extrapolate spectral data following standard CIE15-2018.
...
def cie_interp_(data, wl_new, kind = None, sprague5_allowed = False, negative_values_allowed = False,
               extrap_values = 'ext', extrap_kind = 'linear', extrap_log = False):
    """
    Interpolate / extrapolate spectral data following standard CIE15-2018.
    ...
    if (kind is not None):
        ...
        if (not np.array_equal(data[0],wl_new)) | np.isnan(data).any():
            ...
            # looping required as some values might be NaN's:
            for i in range(S.shape[0]):
