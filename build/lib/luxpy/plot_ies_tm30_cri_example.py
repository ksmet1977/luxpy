...
if plot_iestm30_output == True:
    ...
    data = lx.cri.plot_cri_graphics(SPD, cri_type = 'iesrf', axtype = axtype, ax = None, plot_center_lines = False, plot_edge_lines = True, scalef = normalized_chroma_ref*1, force_CVG_layout = True)
