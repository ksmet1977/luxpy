...
###################################################################################################
# _UNIQUE_HUE_DATA: database of unique hues with corresponding Hue quadratures 
                and eccentricity factors (ciecam97s, ciecam02, cam16, cam15u)

# _SURROUND_PARAMETERS: database of surround parameters c, Nc, F and FLL 
...
# _CAM_SWW16_PARAMETERS: database with cam_sww16 parameters 
    (model by Smet, Webster and Whitehead published in JOSA A in 2016)
...
# cam_sww16(): calculates output for the CAM developed by Smet, Webster and Whitehead 
                 Smet, K. A. G., Webster, M. A., & Whitehead, L. A. (2016). 
                 A simple principled approach for modeling and understanding 
                 uniform color metrics. 
