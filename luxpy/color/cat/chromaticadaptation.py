...
_MCATS['judd-1945-CIE016'] = np2d([[0.0, 1.0, 0.0],[-0.460,1.360,0.102],[0.0,0.0,1.0]]) # from CIE16-2004, Eq.4, a23 modified from 0.1 to 0.1020 for increased accuracy
_MCATS['judd-1945'] = np2d([[0.0, 1.0, 0.0],[-0.460,1.359,0.101],[0.0,0.0,1.0]]) # from Judd's 1945 paper: Deane B. Judd, "Standard Response Functions for Protanopic and Deuteranopic Vision," J. Opt. Soc. Am. 35, 199-221 (1945)
