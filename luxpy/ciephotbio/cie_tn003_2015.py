...
from .. import np, _PKG_PATH, _SEP, _CIEOBS, _CMF, _BB, np2d, spd, getdata, getwld, vlbar,spd_to_power, spd_normalize
...
_ACTIONSPECTRA = getdata(_PKG_PATH + _SEP + 'data' + _SEP + 'ciephotbio' + _SEP + 'cie_tn003_2015_SI_action_spectra.dat', header = 'infer', kind ='np', verbosity = 0).T
