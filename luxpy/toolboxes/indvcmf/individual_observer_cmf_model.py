...
_DSRC_LMS_ODENS_DEF = 'asano' # default data source for lms absorbances and optical densities
_LMS_TO_XYZ_METHOD = 'asano' # default method to calculate lms to xyz conversion matrix
...
def _compute_XYZ(L_spline, M_spline, S_spline, V_spline,
    ...
    wl_x_min_ref = 502
    wl_390_830 = np.arange(390, 831)
    LMS_390_830 = np.array([L_spline(np.arange(390, 831)),
...
#        warnings.warn('wl_all != [390, 830, 0.1]')
    ...
    # =========================================================================
    if ('xyz' in out_list) | ('M' in out_list): 
